    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-rose-100 text-gray-800 font-serif  rounded-lg shadow-xl ">
      <header className="bg-white shadow-md">
        <div className="container mx-auto px-6 py-4">
          <h1 className="text-3xl font-bold text-gray-800">Eulogy Generator by LimeParrot Tech</h1>
        </div>
      </header>
      ...
      <main className="container rounded-lg shadow-xl  mx-auto px-6 py-12 max-w-4xl">
          ...
          <div className="p-8">
            <h2 className="text-4xl font-bold mb-6 text-gray-900">Celebrating Lives, Crafting Legacies: Introducing Eulogy Generator</h2>
      ...
      <footer className="bg-gray-800 text-white mt-12 py-8">
        <div className="container mx-auto px-6 text-center">
          <p>&copy; 2024 Eulogy Generator Eulogy Generator. Crafting legacies with compassion and technology.</p>
        </div>
      </footer>
    </div>
  )
